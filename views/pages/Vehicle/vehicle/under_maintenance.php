...
$under_maintenance_vehicles = Vehicle::under_maintenance_vehicles($vehicleStatus->id);

?>


<div class="row">
    <?php if (count($under_maintenance_vehicles)): ?>
    <div class="col-xl-12">
        <h6 class="mb-0 text-uppercase">All vehicles IN Under Maintenance</h6>
        <hr>
        <div class="card shadow">
            <div class="card-body">
                <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        <?php foreach ($under_maintenance_vehicles as $vehicle): ?>
                            <tr class="text-center">
                                <td>
    ...
    <?php else: ?>
        <div class="mt-5 w-50 d-flex justify-content-center align-items-center text-bg-danger mx-auto p-2 rounded-2">
            <h2 class="fs-4 py-2 text-center text-text-white-50">There are no Available Vehicles In Under Maintenance.</h2>
        </div>
    <?php endif;?>
</div>