<?php
    ...
    class User {
        ...
        function __construct($id, $fname, $lname, $phone, $email, $password, $role_id, $image = null, $owner_id = null, $driver_id = null) {
            $this->id = $id;
        ...
        public function create_user() {
            ...
            $stmnt = $db->prepare("INSERT INTO {$tx}users(id, first_name, last_name, phone, email, password, role_id, image, owner_id, driver_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $stmnt->bind_param("isssssisii", $this->id, $this->first_name, $this->last_name, $this->phone, $this->email, $this->password, $this->role_id, $this->image, $this->owner_id, $this->driver_id);
        ...
        public static function get_users() {
            global $db;
            $stmnt = $db->prepare("SELECT * FROM users_view");
            $stmnt->execute();
        ...
        public static function get_user($value) {
            ...
            $stmnt = $db->prepare("SELECT * FROM users_view WHERE email = ? OR id = ?");
        ...
        // Get first name and last name of a user by driver_id
        public static function get_user_by_driver_id($driver_id) {
            global $db;
            $stmnt = $db->prepare("SELECT CONCAT(first_name, ' ',last_name) as full_name FROM users_view WHERE driver_id = ?");
        ...
        public function update_user() {
            global $db, $tx;
            $stmnt = $db->prepare("UPDATE {$tx}users SET first_name = ?, last_name = ?, phone = ?, email = ?, role_id = ? WHERE id = ?");
            $stmnt->bind_param("ssssii", $this->first_name, $this->last_name, $this->phone, $this->email, $this->role_id, $this->id);
